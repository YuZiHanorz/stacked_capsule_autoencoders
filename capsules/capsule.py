...
class CapsuleLayer(snt.AbstractModule):
    ...
    """
        ...
        votes = tf.matmul(ccr_per_vote, cpr)
        global save_op
        save_op = io_ops._save(filename="/work/07521/zhyu1214/maverick2/Capsule/stacked_capsule_autoencoders/vote_m_100.ckpt", tensor_names=["cpr", "ccr", "vote"], tensors=[cpr, ccr_per_vote, votes])
